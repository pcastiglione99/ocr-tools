...
def detect_page_corners(image_path):
    # Load the image
...
def process_image(points, imagePath):
...
if __name__ == "__main__":
    image_path = "ciao.jpg"  # Replace with the path to your image
    corners = detect_page_corners(image_path)
    process_image(corners, image_path)
